...
export PASS=${GENERATED_POSTGRES_PASS}

# postgres user settings
export USER=${POSTGRES_USER_NAME}
...
export MD5=d37fbcb2f0300821cb14c80dfc87ca87
...
# autogenerated postgres pass
export PG_PASS=${GENERATED_POSTGRES_PASS}

# postgres user settings
export PG_USER=${POSTGRES_USER_NAME}
...
" > ${REDMINE_SECRET_CONFIG_FILE}
echo "wrote $REDMINE_SECRET_CONFIG_FILE"
